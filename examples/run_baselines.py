...
from examples.models.depthwise_conv import DepthwiseSeparableConvGWO
...
def main():
    models_to_benchmark = {
        "StandardConv": StandardConvGWO,
        "DepthwiseConv": DepthwiseSeparableConvGWO,
        "DeformableConv": DeformableConvGWO,
    }
    ...
    for name, gwo_class in models_to_benchmark.items():
        ...
        model = BaselineNetGWO(gwo_class)
